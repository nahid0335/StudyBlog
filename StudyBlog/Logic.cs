...
namespace StudyBlog
{
    public class Logic
    {
        SqlConnection con = new SqlConnection(@"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=D:\Program Files\blog\StudyBlog\StudyBlog\App_Data\BlogDB.mdf;Integrated Security=True");
        SqlCommand cmd;
